...
class DQN(nn.Module):
    ...
    def __init__(self, x, y, z):
        ...
        self.dense6 = nn.Linear(1024, 512)
        self.Lrelu4 = nn.LeakyReLU(negative_slope=0.2)
        self.dense7 = nn.Linear(512, 256)
        self.Lrelu5 = nn.LeakyReLU(negative_slope=0.2)
        self.dense8 = nn.Linear(256, 128)
        self.Lrelu6 = nn.LeakyReLU(negative_slope=0.2)
        self.dense9 = nn.Linear(128, 64)
        self.Lrelu7 = nn.LeakyReLU(negative_slope=0.2)
        self.dense10 = nn.Linear(64, z)

        # Number of Linear input connections depends on output of conv2d layers
        # and therefore the input image size, so compute it.d
