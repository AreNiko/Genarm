...
%variables:
    ...
    %noVoxToRemove: Number of voxel-levels to remove for each generation
...
[vG_work1, figcount] = gengrow(env, origo, arm_radiusx, arm_radiusy, wrist_radius, height, thickness, gt, noVoxToRemove, weight_hand, weight_want, arm_height, figcount, "same");
